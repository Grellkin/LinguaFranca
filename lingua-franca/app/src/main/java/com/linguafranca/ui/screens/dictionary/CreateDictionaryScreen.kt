...
fun CreateDictionaryScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            Text(
                text = "Create a custom dictionary to organize your vocabulary",
            ...
            OutlinedTextField(
                ...
                placeholder = { Text("What kind of words will this contain?") },
                modifier = Modifier.fillMaxWidth(),
                minLines = 3,
                maxLines = 5,
                shape = RoundedCornerShape(12.dp)
            ...
            Button(
                onClick = {
                    if (name.isBlank()) {
                        error = "Please enter a dictionary name"
                    } else {
                        viewModel.createDictionary(name.trim(), description.trim()) {
                            onDictionaryCreated()
                        }
                    }
                },
